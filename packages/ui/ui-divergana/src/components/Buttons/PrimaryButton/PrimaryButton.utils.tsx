...
export const cvaPrimaryButton =cva([],{
	...
	buttonStyle: {
		shadow: '', // variant primary/secondary compound case A.
		outlined: '', // variant  primary/secondary compound case B.
		text: '', // variant  primary/secondary compound case C.
		default: '' // variant  primary/secondary compound case D.
	},
},
compoundVariants: [
